...
public class TestOrderItem {
	...
	public void testTotalPriceSingleOrderItem() {
		...
		assertEquals(expectedTaxedPrice, orderItem.getTotalPrice(newOrder));
	...
	public void testTotalPriceMultipleOrderItem() {
		...
		assertEquals(expectedTaxedPrice.multiply(new BigDecimal(quantity)), orderItem.getTotalPrice(newOrder));
